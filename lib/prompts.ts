...
Extract these important numbers, one item each: grade weights (e.g. a component worth 25%), grading-scale thresholds (e.g. A = 93), curve or grade-adjustment targets (e.g. "the median is shifted to 81%"), rounding thresholds (e.g. "89.5% or higher rounds up to 90%"), assessment counts (e.g. 3 exams), late or attendance penalties (e.g. 10% per day), credit hours or units, due dates and exam dates, class or office-hours times, and section numbers. The full grading policy matters: if the syllabus states more than one grading method or a curve/rounding rule, extract every stated number in it, not just the headline weights. Do not extract page numbers, footnote markers, or numbers with no course meaning.
