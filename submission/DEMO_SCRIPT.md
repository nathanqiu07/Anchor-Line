...
| 0:35–1:05 | Cedar Ridge analysis, transcription visible | Hover or tap the Cedar Ridge Grant card. “The card explains this as gift aid, and the matching text is highlighted in the source. Each explanation stays tied to a quote instead of asking you to trust a summary.” Toggle to **Original** briefly, then return to **Transcription**. |
...
| 1:25–1:45 | Back on landing page, Juniper Technical Institute sample | Return home and open the Juniper Technical Institute synthetic sample. “Different schools use different terms and may leave essential context out.” |
...
| 2:45–3:00 | A card with the amber honesty badge | End tightly framed on **not stated in letter**. “When the source cannot support a claim, the honest answer is ‘not stated in letter.’ On our checked-in synthetic evaluation, Anchor Lines verified **100.0%** of anchors — **12/12** — while keeping that uncertainty visible.” |

End on the **not stated in letter** badge and the 100.0% (12/12) measured
synthetic anchor-verification rate. Do not imply that the sample result is a
real-letter accuracy claim.
